...
public class CannonView extends SurfaceView
   ...
   public static final double CANNONBALL_RADIUS_PERCENT = 2.0 / 80;
   public static final double CANNONBALL_SPEED_PERCENT = 1.0;

   // constants for the Targets
   public static final double TARGET_LENGTH_PERCENT = 1.5 / 40;
   public static final double TARGET_WIDTH_PERCENT = 3.8 / 20;
   public static final double TARGET_FIRST_X_PERCENT = 0.5 / 60;
   public static final double TARGET_SPACING_PERCENT = 0.5 / 60;
   public static final double TARGET_PIECES = 30;
   ...
   public void newGame() {
      ...
      int paddleLength = (int) TARGET_LENGTH_PERCENT * screenWidth;
      int paddleHeight = (int) TARGET_WIDTH_PERCENT * screenHeight;
      cannon = new Cannon(this, Color.BLACK, (screenWidth / 2) - (paddleLength / 2), (screenHeight - 500) - (paddleHeight/ 2),
      ...
      int targetY = (int) (TARGET_LENGTH_PERCENT * screenHeight);

      // add TARGET_PIECES Targets to the Target list
      for (int n = 1; n <= TARGET_PIECES; n++) {
...
//      angle = Math.atan2(touchPoint.x, centerMinusY);
   ...
   // checks if the ball collides with the any of the Targets
      ...
      if (cannon.getCannonball() != null &&
         ...
         for (int n = 0; n < targets.size(); n++) {
            if (cannon.getCannonball().collidesWith(targets.get(n))) {
               ...
               cannon.getCannonball().reverseVelocity(); // reverse velocity
